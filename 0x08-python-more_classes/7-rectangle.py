...
class Rectangle:
    """
     ...
     Attributes:
        ...
        print_symbol:Can be any type.Initialized to #.Used
    ...
    def __str__(self):
        ...
        Returns:
            string:string with a rectangle(#)
       """
        string = ""
        if self.__width == 0 or self.__height == 0:
            return string
    ...
    def __repr__(self):
        """
        repr method :recreates new instance of rectange using eval()
    ...
    def __del__(self):
        """
        del method :called when the instance is about to
        be destroyed and if there is no other reference to this instance.
        """
        print("Bye rectangle...")
        type(self).number_of_instances -= 1
